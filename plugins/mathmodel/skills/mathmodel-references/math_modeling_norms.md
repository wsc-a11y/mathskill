...
| 小节 | 主要使用方 |
| --- | --- |
| [赛题理解与子问题识别](#赛题理解与子问题识别) | `mathmodel-modeling` |
| [假设与模型建立](#假设与模型建立) | `mathmodel-modeling` |
| [题型防错速查](#题型防错速查) | `mathmodel-modeling` `mathmodel-figures` |
| [代码实现与结果](#代码实现与结果) | `mathmodel-figures` |
| [编码阶段常见错误](#编码阶段常见错误) | `mathmodel-figures` |
| [图表与可视化](#图表与可视化) | `mathmodel-figures` `mathmodel-drawio` `mathmodel-paper` |
| [非数据图工具选择](#非数据图工具选择) | `mathmodel-drawio` `mathmodel-paper` |
| [论文写作](#论文写作) | `mathmodel-paper` |
| [论文验收与一致性](#论文验收与一致性) | `mathmodel-verify` |
| [模型大分类与选型速查](#模型大分类与选型速查) | `mathmodel-modeling` |
| [评价类模型详细指南](#评价类模型详细指南) | `mathmodel-modeling` `mathmodel-figures` |
| [预测类模型详细指南](#预测类模型详细指南) | `mathmodel-modeling` `mathmodel-figures` |
| [优化类模型详细指南](#优化类模型详细指南) | `mathmodel-modeling` `mathmodel-figures` |
| [机理/动力学类模型详细指南](#机理动力学类模型详细指南) | `mathmodel-modeling` `mathmodel-figures` |
| [图论与网络类模型](#图论与网络类模型) | `mathmodel-modeling` `mathmodel-figures` |
| [统计分析与机器学习](#统计分析与机器学习) | `mathmodel-modeling` `mathmodel-figures` |
| [论文写作规范补充](#论文写作规范补充) | `mathmodel-paper` |
| [美赛（MCM/ICM）专项规范](#美赛mcmicm专项规范) | `mathmodel-paper` |
